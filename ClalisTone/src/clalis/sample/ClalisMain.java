...
//  概要      : Clalis 口調変換 ClalisTone サンプル
//
...
public class ClalisMain {
	...
	public static void main(String[] args) {
		...
		//結果の取得
		String jsonText = inputStreemToString(post("http://liplis.mine.nu/Clalis/v30/Post/Json/ClalisTone.aspx", nameValuePair).getEntity().getContent());

		//API結果受け取り用クラス
		ResTone result =  new Gson().fromJson(jsonText, ResTone.class);
