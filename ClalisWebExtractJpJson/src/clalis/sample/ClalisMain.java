...
//  概要      : Clalis Web日本語抽出 ClalisWebExtractJp
//
...
public class ClalisMain {
	...
	public static void main(String[] args) {
		try{
			...
			//結果の取得
			String jsonText = inputStreemToString(post("http://liplis.mine.nu/Clalis/v30/Post/Json/clalisWebExtractJp.aspx", nameValuePair).getEntity().getContent());

			//API結果受け取り用クラス
			ResWebSummary result =  new Gson().fromJson(jsonText, ResWebSummary.class);
