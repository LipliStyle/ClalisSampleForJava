...
public class ClalisMain {
	...
	public static void main(String[] args) {
		try{
			...
			//結果の取得
			String jsonText = inputStreemToString(post("http://liplis.mine.nu/Clalis/v30/Post/Json/clalisWebExtractJpSentenceRelevanceList.aspx", nameValuePair).getEntity().getContent());
